...
IIOT_KEEP_PROTOCOLS = frozenset(["mqtt", "data"])
...
def prepare_datasets():
    ...
    benign_data = pd.read_csv(RAW_BENIGN_DATA_PATH, usecols=target_columns)
    attack_data = pd.read_csv(RAW_ATTACK_DATA_PATH, usecols=target_columns)
    return
